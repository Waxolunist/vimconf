...
highlight asciidocBackslash ctermfg=lightmagenta guifg=lightmagenta
highlight asciidocBiblio term=bold ctermfg=darkcyan cterm=bold guifg=darkcyan gui=bold
highlight asciidocDoubleDollarPassthrough term=underline ctermfg=lightmagenta guifg=lightmagenta
highlight asciidocFootnote term=underline ctermfg=lightmagenta guifg=lightmagenta
highlight asciidocGlossary term=underline ctermfg=lightgreen cterm=underline guifg=lightgreen gui=underline
highlight asciidocHLabel term=underline ctermfg=lightgreen cterm=underline guifg=lightgreen gui=underline
highlight asciidocInclude term=underline ctermfg=lightmagenta guifg=lightmagenta
highlight asciidocQuestion term=underline ctermfg=lightgreen cterm=underline guifg=lightgreen gui=underline
...
highlight asciidocQuotedEmphasized term=bold ctermfg=lightgreen guifg=lightgreen gui=italic
...
highlight asciidocQuotedUnconstrainedEmphasized term=bold ctermfg=lightgreen guifg=lightgreen gui=italic
...
highlight asciidocReference term=underline ctermfg=lightmagenta guifg=lightmagenta
...
highlight asciidocTripplePlusPassthrough term=underline ctermfg=lightmagenta guifg=lightmagenta

"Attributes
highlight asciidocAttributeEntry term=standout ctermfg=lightgreen guifg=lightgreen
highlight asciidocAttributeList term=standout ctermfg=lightgreen guifg=lightgreen
highlight link asciidocAttributeMacro Macro
"highlight asciidocAttributeRef term=standout ctermfg=lightgreen cterm=bold guifg=lightgreen gui=bold
highlight asciidocAttributeRef term=standout,underline ctermfg=lightgreen cterm=bold,underline guifg=lightgreen gui=bold,underline
...
highlight asciidocListLabel term=underline ctermfg=lightgreen cterm=underline guifg=lightgreen gui=underline
highlight asciidocListNumber term=bold ctermfg=darkcyan cterm=bold guifg=darkcyan gui=bold

"Sections
highlight asciidocSect0 term=bold,underline ctermfg=lightmagenta cterm=bold,underline guifg=lightmagenta gui=bold,underline
highlight asciidocSect1 term=underline ctermfg=lightmagenta cterm=underline guifg=lightmagenta gui=underline
highlight asciidocSect2 term=underline ctermfg=lightmagenta cterm=underline guifg=lightmagenta gui=underline
highlight asciidocSect3 term=underline ctermfg=lightmagenta cterm=underline guifg=lightmagenta gui=underline
highlight asciidocSect4 term=underline ctermfg=lightmagenta cterm=underline guifg=lightmagenta gui=underline
highlight asciidocSect0Old term=underline ctermfg=lightmagenta cterm=bold guifg=lightmagenta gui=bold
highlight asciidocSect1Old term=underline ctermfg=lightmagenta guifg=lightmagenta
highlight asciidocSect2Old term=underline ctermfg=lightmagenta guifg=lightmagenta
highlight asciidocSect3Old term=underline ctermfg=lightmagenta guifg=lightmagenta
highlight asciidocSect4Old term=underline ctermfg=lightmagenta guifg=lightmagenta

"Links
highlight asciidocEmail term=underline ctermfg=lightred cterm=underline guifg=lightred gui=underline
highlight asciidocLink term=underline ctermfg=lightred cterm=underline guifg=lightred gui=underline
...
highlight asciidocURL term=underline ctermfg=lightred cterm=underline guifg=lightred gui=underline

"Blocks
highlight asciidocBlockTitle term=underline ctermfg=lightgreen cterm=underline guifg=lightgreen gui=underline
...
"Macros
highlight asciidocAnchorMacro term=standout ctermfg=lightred guifg=lightred
highlight link asciidocIndexTerm Macro
highlight asciidocMacro term=underline ctermfg=lightred cterm=underline guifg=lightred gui=underline
highlight asciidocMacroAttributes term=bold ctermfg=darkyellow guifg=darkyellow
highlight asciidocRefMacro term=standout ctermfg=lightred guifg=lightred
